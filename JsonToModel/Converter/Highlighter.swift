...
enum MyTokenType {
    ...
    static let types: [String] = [
        "Bool", "bool", "Int", "String", "Double", "int", "double", "void", "self", "class_name", "var_name", "var_type", "key", "Data", "CodingKey", "ArrayList", "List", "boolean", "dynamic", "sub_type", "Any", "bool", "float", "str", "list", "string"
    ]
}
